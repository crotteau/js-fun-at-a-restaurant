...
function pantry(stockCount, food) {
    if (stockCount >= 1) {
...
function meals(isFavorite, food) {
    if (isFavorite === true) {
...
var vegetables = ['broccoli', 'celery', 'spinach', 'brussels', 'green beans', 'cabbage'];
...
var fruits = ['strawbery', 'mango', 'apple', 'blueberry', 'banana', 'raspberry', 'cantelope'];
